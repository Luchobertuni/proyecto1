    ...
    <header>
     ...
     <h2> Instaviaje </h2>
      ...
      <nav>
        <ul class="menu2">
          @if (Auth::check())
            <li><a href="/perfil">Perfil :{{ Auth::user()->first_name}}</a></li>
